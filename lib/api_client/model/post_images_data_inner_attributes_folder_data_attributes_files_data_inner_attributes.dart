...
class PostImagesDataInnerAttributesFolderDataAttributesFilesDataInnerAttributes {
  /// Returns a new [PostImagesDataInnerAttributesFolderDataAttributesFilesDataInnerAttributes] instance.
  PostImagesDataInnerAttributesFolderDataAttributesFilesDataInnerAttributes({
    this.name,
  ...
  @override
  String toString() => 'PostImagesDataInnerAttributesFolderDataAttributesFilesDataInnerAttributes[name=$name, alternativeText=$alternativeText, caption=$caption, width=$width, height=$height, formats=$formats, hash=$hash, ext=$ext, mime=$mime, size=$size, url=$url, previewUrl=$previewUrl, provider=$provider, providerMetadata=$providerMetadata, related=$related, folder=$folder, folderPath=$folderPath, createdAt=$createdAt, updatedAt=$updatedAt, createdBy=$createdBy, updatedBy=$updatedBy]';
  ...
  /// Returns a new [PostImagesDataInnerAttributesFolderDataAttributesFilesDataInnerAttributes] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static PostImagesDataInnerAttributesFolderDataAttributesFilesDataInnerAttributes? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "PostImagesDataInnerAttributesFolderDataAttributesFilesDataInnerAttributes[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "PostImagesDataInnerAttributesFolderDataAttributesFilesDataInnerAttributes[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return PostImagesDataInnerAttributesFolderDataAttributesFilesDataInnerAttributes(
  ...
  static List<PostImagesDataInnerAttributesFolderDataAttributesFilesDataInnerAttributes> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <PostImagesDataInnerAttributesFolderDataAttributesFilesDataInnerAttributes>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = PostImagesDataInnerAttributesFolderDataAttributesFilesDataInnerAttributes.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, PostImagesDataInnerAttributesFolderDataAttributesFilesDataInnerAttributes> mapFromJson(dynamic json) {
    final map = <String, PostImagesDataInnerAttributesFolderDataAttributesFilesDataInnerAttributes>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = PostImagesDataInnerAttributesFolderDataAttributesFilesDataInnerAttributes.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of PostImagesDataInnerAttributesFolderDataAttributesFilesDataInnerAttributes-objects as value to a dart map
  static Map<String, List<PostImagesDataInnerAttributesFolderDataAttributesFilesDataInnerAttributes>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<PostImagesDataInnerAttributesFolderDataAttributesFilesDataInnerAttributes>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = PostImagesDataInnerAttributesFolderDataAttributesFilesDataInnerAttributes.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
